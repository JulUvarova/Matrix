...
Реализация библиотеки matrix.h для обработки числовых матриц на языке программирования С. М
...
- Подготовено полное (>80%) покрытие unit-тестами функций библиотеки c помощью библиотеки Check.
- Матрица реализована в виде структуры, описанной ниже.
- Проверяемая точность дробной части - максимум 6 знаков после запятой.


**Сборка**
* all - сборка библиотеки *s21_decimal.a*
  ```
  make all
  ```
...
* gcov_report - создание отчета о тестовом покрытии 
  ```
  make gcov_report
  ```
